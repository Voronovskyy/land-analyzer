...
public class WeatherChartGenerator {
    ...
    public static Canvas createChart(JsonObject daily) {
        ...
        double ly = 9;
        gc.setLineWidth(2.5);
        gc.setStroke(Color.web("#e74c3c")); gc.strokeLine(lx, ly + 4, lx + 16, ly + 4);
        gc.setFill(Color.web("#495057"));   gc.setFont(Font.font(9)); gc.setTextAlign(TextAlignment.LEFT);
        gc.fillText("T max", lx + 20, ly + 8);

        gc.setStroke(Color.web("#3498db")); gc.strokeLine(lx + 72, ly + 4, lx + 88, ly + 4);
        gc.fillText("T min", lx + 92, ly + 8);

        gc.setFill(Color.web("#74b9ff", 0.7)); gc.fillRect(lx + 148, ly, 12, 10);
        gc.setFill(Color.web("#495057")); gc.fillText("Opady", lx + 164, ly + 8);
